        ...
        <div ref={container}>
            <svg className="w-full mb-40" viewBox="0 0 250 90">
                ...
                <text className="text-[6px] uppercase" style={{fill: "red"}}>
                    {
                        [...Array(3)].map((_, i) => {
                            return <textPath key={i} ref={ref => paths.current[i] = ref} startOffset={i * 40 + "%"} href="#curve">Что за бизнес cyka</textPath>
                        })
                    }
                </text>
            </svg>
...
const Logos = ({scrollProgress}) => {
    ...
    return (
        <div className="h-[250px] bg-black overflow-hidden">
            <motion.div style={{y}} className="h-full bg-red-700 flex justify-center gap-10 items-center p-10">
                {
                    [...Array(4)].map((_, i) => {
